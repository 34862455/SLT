...
from signjoey.s3d import S3D
# from signjoey.VGGNET import Vgg
from signjoey.head import HeadNetwork,MultDimConv, LinearHead, LinearLink
from signjoey.encoders import Encoder, RecurrentEncoder, TransformerEncoder
from signjoey.decoders import Decoder, RecurrentDecoder, TransformerDecoder, BERTDecoder, GPT2Decoder
...
class SignModel(nn.Module):
    ...
    def __init__(
        ...
        # weight_dict = torch.load('/home/botlhale/Documents/Mokgadi_masters/checkpoints/Sign2Text linear 2/sign_sample_model/42500.ckpt')["model_state"]
        ...
        # self.vgg = Vgg(n_classes=1024)

        # head = HeadNetwork(1024,512)
        # weight_dict = torch.load('/home/botlhale/Documents/Mokgadi_masters/checkpoints/Sign2Text linear 2/sign_sample_model/42500.ckpt')["model_state"]
        ...
        # self.head = head
        # self.link = LinearLink(1024,1024)
    ...
    def get_loss_for_batch(
        ...
        if self.do_translation:
            ...
            # print("outputs",word_outputs)
            # Calculate Translation Loss
            txt_log_probs = F.log_softmax(word_outputs, dim=-1)
            # print("the logits",txt_log_probs, batch.txt)
            translation_loss = (
